        ...
        <div class="header-element">
          <div class="horizontal-logo">
            <a href="http://localhost:3000" class="header-logo">
              ...
              <img src="../../public/assets/images/brand-logos/desktop-white.png" alt="logo" class="desktop-white">
              <img src="../../public/assets/images/brand-logos/toggle-white.png" alt="logo" class="toggle-white">-->
            </a>
          </div>
        </div>
        <!-- End::header-element -->
      ...
      <div class="header-content-right">
        ...
        <div class="header-element py-[1rem] md:px-[0.65rem] px-2  header-country hs-dropdown ti-dropdown  hidden sm:block [--placement:bottom-right] rtl:[--placement:bottom-left]">
          <button id="dropdown-flag" type="button"
            ...
            <img src="../../public/assets/images/flags/us_flag.jpg" alt="flag-img" class="h-[1.25rem] w-[1.25rem] rounded-full">
          </button>
            ...
            <div class="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
              <div class="py-2 first:pt-0 last:pb-0">
                <div class="ti-dropdown-item !p-[0.65rem] ">
                  <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                    <div class="h-[1.375rem] flex items-center w-[1.375rem] rounded-full">
                      <img src="../../public/assets/images/flags/us_flag.jpg" alt="flag-img"
                ...
                <div class="ti-dropdown-item !p-[0.65rem]">
                  <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                    <div class="h-[1.375rem] w-[1.375rem] flex items-center rounded-full">
                      <img src="../../public/assets/images/flags/spain_flag.jpg" alt="flag-img"
                        class="h-[1rem] w-[1rem] rounded-full">
                    </div>
                    <div>
                      <p class="!text-[0.8125rem] font-medium">
                ...
                <div class="ti-dropdown-item !p-[0.65rem]">
                  <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                    <div class="h-[1.375rem] w-[1.375rem] flex items-center rounded-full">
                      <img src="../../public/assets/images/flags/french_flag.jpg" alt="flag-img"
                        class="h-[1rem] w-[1rem] rounded-full">
                    </div>
                    <div>
                      <p class="!text-[0.8125rem] font-medium">
                ...
                <div class="ti-dropdown-item !p-[0.65rem]">
                  <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                    <div class="h-[1.375rem] w-[1.375rem] flex items-center rounded-full">
                      <img src="../../public/assets/images/flags/germany_flag.jpg" alt="flag-img"
                        class="h-[1rem] w-[1rem] rounded-full">
                    </div>
                    <div>
                      <p class="!text-[0.8125rem] font-medium">
                ...
                <div class="ti-dropdown-item !p-[0.65rem]">
                  <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                    <div class="h-[1.375rem] w-[1.375rem] flex items-center rounded-full">
                      <img src="../../public/assets/images/flags/italy_flag.jpg" alt="flag-img"
                        class="h-[1rem] w-[1rem] rounded-full">
                    </div>
                    <div>
                      <p class="!text-[0.8125rem] font-medium">
                ...
                <div class="ti-dropdown-item !p-[0.65rem]">
                  <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                    <div class="h-[1.375rem] w-[1.375rem] flex items-center  rounded-sm">
                      <img src="../../public/assets/images/flags/russia_flag.jpg" alt="flag-img"
                        class="h-[1rem] w-[1rem] rounded-full">
                    </div>
                    <div>
                      <p class="!text-[0.8125rem] font-medium">
            ...
            <ul class="list-none mb-0" id="header-cart-items-scroll">
              <li class="ti-dropdown-item border-b !block dark:border-defaultborder/10 border-defaultborder ">
                <div class="flex items-start cart-dropdown-item">
                  ...
                  <img src="../../public/assets/images/ecommerce/jpg/1.jpg" alt="img"
              ...
              <li class="ti-dropdown-item border-b !block dark:border-defaultborder/10 border-defaultborder">
                <div class="flex items-start cart-dropdown-item">
                  <img src="../../public/assets/images/ecommerce/jpg/3.jpg" alt="img"
                    class="!h-[1.75rem] !w-[1.75rem] leading-[1.75rem] text-[0.65rem]  rounded-[50%] br-5 me-3">
                  <div class="grow">
                    <div class="flex items-start justify-between mb-0">
              ...
              <li class="ti-dropdown-item border-b !block dark:border-defaultborder/10 border-defaultborder">
                <div class="flex items-start cart-dropdown-item">
                  <img src="../../public/assets/images/ecommerce/jpg/5.jpg" alt="img"
                    class="!h-[1.75rem] !w-[1.75rem] leading-[1.75rem] text-[0.65rem]  rounded-[50%] br-5 me-3">
                  <div class="grow">
                    <div class="flex items-start justify-between mb-0">
                      <div class="mb-0 text-[0.8125rem] text-[#232323] font-semibold dark:text-white">
              ...
              <li class="ti-dropdown-item border-b !block dark:border-defaultborder/10 border-defaultborder">
                <div class="flex items-start cart-dropdown-item">
                  <img src="../../public/assets/images/ecommerce/jpg/4.jpg" alt="img"
                    class="!h-[1.75rem] !w-[1.75rem] leading-[1.75rem] text-[0.65rem]  rounded-[50%] br-5 me-3">
                  <div class="grow">
                    <div class="flex items-start justify-between mb-0">
                      <div class="mb-0 text-[0.8125rem] text-[#232323] font-semibold dark:text-white">
              ...
              <li class="ti-dropdown-item !block">
                <div class="flex items-start cart-dropdown-item">
                  <img src="../../public/assets/images/ecommerce/jpg/6.jpg" alt="img"
                    class="!h-[1.75rem] !w-[1.75rem] leading-[1.75rem] text-[0.65rem]  rounded-[50%] br-5 me-3">
                  <div class="grow">
                    <div class="flex items-start justify-between mb-0">
                      <div class="mb-0 text-[0.8125rem] text-[#232323] font-semibold dark:text-white">
