...
<template>
  <div class="">
    ...
    <section class="section my-5 mb-10 py-5 bg-ash text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem] " id="pricing">
        <div class="container text-center">
    ...
    <section class="section my-5 py-5 bg-ash section-bg text-defaulttextcolor dark:text-defaulttextcolor/70 text-[0.813rem]" id="contact">
        <div class="container text-center">
