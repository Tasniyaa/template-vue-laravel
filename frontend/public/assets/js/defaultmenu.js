...
//       document.querySelectorAll(".slide-menu").forEach((ele) => {
//         const toggled = document.querySelector("html").getAttribute("data-toggled");
//         if (toggled === "menu-click-closed" || toggled === "icon-click-closed") {
//           ele.style.display = "none";
//         }
//       });
//     });
...
function setupMenuToggle() {
  ...
  if (mainContent) {
    mainContent.addEventListener("click", () => {
      document.querySelectorAll(".slide-menu").forEach((ele) => {
        const dataToggled = document.querySelector("html").getAttribute("data-toggled");
        if (dataToggled === "menu-click-closed" || dataToggled === "icon-click-closed") {
          ele.style.display = "none";
        }
      });
    });
